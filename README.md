...
<p align="center">
  ...
  <h3 align="center">WEB601 Dynamic Web Technology - Project</h3>

  <p align="center">
    Web site development project.
    <br />
    <a href="https://github.com/Jason-MacDonald/WEB601-Project/tree/master/client"><strong>Explore the docs »</strong></a>
    <br />
    <br />
  </p>
</p>
...
1. Clone the repo
```sh
git clone https://github.com/Jason-MacDonald/WEB601-Project.git
```
...
1. Open a terminal on the top level client directory
```sh
npm start
```
...
See the [open issues](https://github.com/Jason-MacDonald/WEB601-Project/issues) for a list of proposed features (and known issues).
...
Project Link: [WEB601 Project](https://github.com/Jason-MacDonald/WEB601-Project)
...
[contributors-url]: https://github.com/Jason-MacDonald/WEB601-Project/graphs/contributors
